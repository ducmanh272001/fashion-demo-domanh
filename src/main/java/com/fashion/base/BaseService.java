...
///Tính tổng tiền
	...
	public static List<CustomerEntity> listKhachHang() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/customer/";
	...
	public static List<Long> listLongIdSpFromHotProduct() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/hot-product/listLongIdSP";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static int InsertKhachHang(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/customer/insert";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
		String trave = response.readEntity(String.class);
	...
	public static int insertCalcuate(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/calculate/insert";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
		String trave = response.readEntity(String.class);
	...
	public static long quantityCalcualate(Integer productId) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/calculate/search-quantity/" + productId;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new Gson();
	...
	public static String deleteCalculate(Integer calculidateId) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/calculate/delete/" + calculidateId;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
	...
	public static String deleteCalculateFromProductId(Integer productId) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/calculate/delete-productId/" + productId;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		CalculateEntity calculateEntity = new CalculateEntity();
		Gson gs = new Gson();
	...
	public static String getUrlpayment(String total) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/payment/create-payment?amount=" + total;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
	...
	public static CustomerEntity selectByKhachHang(int id) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/customer/search/" + id;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static UserEntity selectUserFromEmail(String email) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/user/search-email/" + email;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static String saveHotProduct(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/hot-product/";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
		String trave = response.readEntity(String.class);
	...
	public static String saveRole(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/role/insert";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
		String trave = response.readEntity(String.class);
	...
	public static String updateRole(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/role/update";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
	...
	public static HotProductEntity findAllHotProductByIdsp(long idla) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/hot-product/find-idsp/" + idla;
		Gson gs = new Gson();
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String trave = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<CalculateEntity> listCanculate(Integer productId) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/calculate/" + productId;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> findAllProductsByIdList() {
		...
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/listIdSp";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static String updateHotProduct(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/hot-product/update";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
		String suatc = response.readEntity(String.class);
	...
	public static List<ProductEntity> ListDamSanPham(Model model) {
		String URLDAM = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/list-san-pham/dam";
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		Client client = ClientBuilder.newClient();
	...
	public static List<ProductEntity> ListShirt(Model model) {
		String URLAO = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/list-san-pham/ao";
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		Client client = ClientBuilder.newClient();
	...
	public static List<ProductEntity> ListSanPhamCaBo(Model model) {
		String URLDAM = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/list-san-pham/ca-bo";
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URLDAM);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<ProductEntity> ListSanPhamAoDai(Model model) {
		String URLDAM = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/list-san-pham/ao-dai";
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URLDAM);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<ProductEntity> ListSanPhamQuan(Model model) {
		String URLDAM = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/list-san-pham/quan";
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URLDAM);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static long CountKhachHang() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/customer/count-khach-hang";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
	...
	public static int CountHoaDon() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/bill/count-hoa-don";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static void SuaKhachHang(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/customer/update";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
	...
	public static void updateUser(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/user/update";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
	}
	...
	public static String deleteKhachHang(int xoaid) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/customer/delete/" + xoaid;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
	...
	public static List<BillEntity> ListHoaDon() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/bill/list";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static String suaHoaDon(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/bill/update";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
		String suatc = response.readEntity(String.class);
	...
	public static BillEntity timHoaDon(int idtim) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/bill/" + idtim;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static String xoaHoaDon(int idxoa) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/bill/delete-hoa-don/" + idxoa;
	...
	public static String deleteBillDetailFromBillId(int billId) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/bill-detail/delete-hoa-don-ct/" + billId;
	...
	public static ProductDetailEntity searchSanPhamCt(int idla) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product-detail/" + idla;
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		Client client = ClientBuilder.newClient();
	...
	public static UserEntity kiemTraDangNhap(String taikhoan, String matkhau) {
		Gson gs = new Gson();
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/user/kiemTraDangNhap/" + taikhoan + "/"
				+ matkhau;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<UserEntity> listUser() {
		// Lấy ra list user
		Gson gs = new Gson();
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/user";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<ProductEntity> PhanTrang(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangAo(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ao/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangDam(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Dam/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangAoDai(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ao-dai/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangCaBo(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ca-bo/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangQuan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Quan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static long count() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/count";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static long countAo() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/count-ao";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Long slsp = Long.parseLong(data);
	...
	public static long countQuan() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/count-quan";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Long slsp = Long.parseLong(data);
	...
	public static long countCaBo() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/count-ca-bo";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Long slsp = Long.parseLong(data);
	...
	public static long countAoDai() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/count-ao-dai";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Long slsp = Long.parseLong(data);
	...
	public static long countDam() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/count-dam";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Long slsp = Long.parseLong(data);
	...
	public static List<ProductEntity> SanPhamTangDan() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/list-san-pham-tang-dan";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> SanPhamGiamDan() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/list-san-pham-giam-dan";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangAoTangDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ao-Tang-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangAoGiamDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ao-Giam-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangDamGiamDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Dam-Giam-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangDamTangDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Dam-Tang-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangQuanTangDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Quan-Tang-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangQuanGiamDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Quan-Giam-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangAoDaiTangDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ao-Dai-Tang-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangAoDaiGiamDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ao-Dai-Giam-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangCaBoGiamDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ca-Bo-Giam-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> PhanTrangCaBoTangDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/Ca-Bo-Tang-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPhamAoMoiNhat() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-moi-nhat-ao";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPhamQuanMoiNhat() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-moi-nhat-quan";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPhamAoDaiMoiNhat() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-moi-nhat-ao-dai";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPhamCaBoMoiNhat() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-moi-nhat-ca-bo";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPhamDamMoiNhat() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-moi-nhat-dam";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> phanTrangSanPhamGiamDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/San-Pham-Giam-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> phanTrangSanPhamTangDan(int page) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/Phan-Trang/San-Pham-Tang-Dan/" + page;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<TypeProductEntity> ListLoaiSanPham() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/type-product/list";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ColorEntity> ListMauSac() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/color";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<SizeEntity> ListKichCo() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/size";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPham100den200() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-100-200";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPham200den300() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-200-300";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPham300den500() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-300-500";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> sanPhamTren500() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/san-pham-gia-tren-500";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static List<ProductEntity> timNhanHieu(int idla, int idphan) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/tim-nhan-hieu/" + idla + "/phan-trang/"
				+ idphan;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static Long countNhanHieu(int idla) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/product/count-nhan-hieu/" + idla;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<CustomerEntity> phanTrangKhachHang(int sotrang) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/customer/phan-trang-khach-hang/" + sotrang;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<BillEntity> phanTrangHoaDon(int sotrang) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/bill/phanTrangHoaDon/" + sotrang;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static Notifies xoaTinTuc(int idxoa) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/news/delete/" + idxoa;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static NewsEntity TimTinTuc(int idtim) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/news/search-id/" + idtim;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<NewsEntity> listTinTuc() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/news/";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static int countTinTuc() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/news/count";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<RoleEntity> selectAllRole() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/role/list";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
	...
	public static List<TypeProductEntity> phanTrangDanhMuc(int sotrang) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/type-product/phan-trang/" + sotrang;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static Notifies themDanhMuc(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/type-product/insert";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
	...
	public static Notifies suaDanhMuc(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/type-product/update";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
	...
	public static Notifies xoaDanhMuc(int idxoa) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/type-product/delete/" + idxoa;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
	...
	public static TypeProductEntity timDanhMuc(int idla) {
		Gson gs = new Gson();
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/type-product/search/" + idla;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<UserRoleEntity> listUserRole() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/user-role/list";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static Notifies InsertUserRole(String data) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/user-role/insert";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		Response response = target.request().post(Entity.entity(data, MediaType.APPLICATION_JSON));
	...
	public static RoleEntity timRole(int idla) {
		Gson gs = new Gson();
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/role/search/" + idla;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static UserEntity timUser(int idla) {
		Gson gs = new Gson();
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/user/search/" + idla;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		String data = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<ImagerEntity> selectAllHinhAnh() {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/imager/list";
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	public static List<ImagerEntity> selectByIdSpHinhAnh(int idha) {
		String URL = "https://fashion-shop-api.herokuapp.com/rest/api/v1/imager/list-tim-idsp/" + idha;
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(URL);
		Gson gs = new Gson();
		String dulieu = target.request(MediaType.APPLICATION_JSON).get(String.class);
