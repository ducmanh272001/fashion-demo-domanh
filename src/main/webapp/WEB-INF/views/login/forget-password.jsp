...
<body>
	<div class="login-page">
		...
		<div class="error" style="display: flex;">
			...
			<sform:form action="${rootpath}forget/confirm" method="post"
				class="login-form" modelAttribute="email">
				<sform:input path="email" type="text" placeholder="Nhập email đăng ký" />
