	...
	<div class="login-page">
		<div class="form" style="border-radius: 40px;">
		  <div class="error" style="display: flex;">
			...
			<sform:form action="${rootpath}success/password/chance" method="post"
				class="login-form" modelAttribute="entity">
				<sform:input cssStyle="display: none" path="id" type="number"/>
				<sform:input path="password" type="text" placeholder="Nhập mật khẩu mới" />
				<sform:errors path="password" class="error" />
				<input name="nhappass" type="text" placeholder="Nhập lại mật khẩu">
