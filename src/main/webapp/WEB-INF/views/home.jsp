...
<body>
					...
					<div class="products-cart-content">
						<div class="products-cart">
							<div class="products-cart-img">
								<a href=""><img src="${rootpath}public/img/product14.png"
									alt=""></a>
							</div>
							<div class="products-cart-content">
								<h3>
	...
	<div class="row">
		<div class="hot-product col-lg-12">
			<h2>
				<fmt:message key="newsp" />
			</h2>
			<p>
				<fmt:message key="hottrend" />
			</p>
			<div class="tab-content" id="myTabContent">
						...
						<div class="col-lg-12">
							<div class="container">
								<div class="hot-product-img">
									<div class="row">
										<c:forEach items="${lspmt}" var="l" begin="0" end="7">
											<div class="col-lg-3 col-md-4 col-sm-6 col-12">
												<div class="hot-product-img-one sanphamoi">
													<div class="thump">
														<span>Mã <b>${l.id}</b></span>
														<div class="image-zoom">
															<c:forEach items="${l.listHinhAnh}" var="p" begin="0"
																end="0">
																<img src="${rootpath}public/img/${p.name}" alt="">
															</c:forEach>
															<c:forEach items="${l.listHinhAnh}" var="p" begin="1"
																end="1">
																<img class="zooom-product"
																	src="${rootpath}public/img/${p.name}" alt="">
															</c:forEach>
														</div>
				...
				<div class="tab-pane fade" id="trendding" role="tabpanel"
											...
											<div class="col-lg-3 col-md-4 col-sm-6 col-12">
												<div class="hot-product-img-one sanphamoi">
													<div class="thump">
														...
														<div class="image-zoom">
															<c:forEach items="${ld.listHinhAnh}" var="p" begin="1"
																end="1">
																<img src="${rootpath}public/img/${p.name}" alt="">
															</c:forEach>
															<c:forEach items="${ld.listHinhAnh}" var="p" begin="2"
																end="2">
																<img class="zooom-product"
																	src="${rootpath}public/img/${p.name}" alt="">
															</c:forEach>
													...
													<div class="content">
														...
														<p>
															<fmt:formatNumber value="${ld.price_new}" type="currency" />
														</p>
													</div>
												</div>
											</div>
											...
											<div class="hot-product-img-one">
												<div class="thump">
													...
													<div class="image-zoom">
														...
														<img class="zooom-product"
															src="${rootpath}public/img/product4.png" alt="">
													</div>
													<div class="icon-hot-product">
											...
											<div class="hot-product-img-one">
												<div class="thump">
													...
													<div class="image-zoom">
														...
														<img class="zooom-product"
															src="${rootpath}public/img/product14.png" alt="">
													</div>
													<div class="icon-hot-product">
														<a href=""><i class="fa-regular fa-heart"></i></a> <a
															href=""><i class="fa-solid fa-expand"></i></a> <a href=""><i
											...
											<div class="hot-product-img-one">
												<div class="thump">
													...
													<div class="image-zoom">
														...
														<img class="zooom-product"
															src="${rootpath}public/img/product6.png" alt="">
													</div>
													<div class="icon-hot-product">
														<a href=""><i class="fa-regular fa-heart"></i></a> <a
															href=""><i class="fa-solid fa-expand"></i></a> <a href=""><i
											...
											<div class="hot-product-img-one">
												<div class="thump">
													...
													<div class="image-zoom">
														...
														<img class="zooom-product"
															src="${rootpath}public/img/product10.png" alt="">
													</div>
													<div class="icon-hot-product">
														<a href=""><i class="fa-regular fa-heart"></i></a> <a
															href=""><i class="fa-solid fa-expand"></i></a> <a href=""><i
											...
											<div class="hot-product-img-one">
												<div class="thump">
													...
													<div class="image-zoom">
														...
														<img class="zooom-product"
															src="${rootpath}public/img/product8.png" alt="">
													</div>
													<div class="icon-hot-product">
														<a href=""><i class="fa-regular fa-heart"></i></a> <a
															href=""><i class="fa-solid fa-expand"></i></a> <a href=""><i
				...
				<div class="tab-pane fade" id="onsall" role="tabpanel"
					aria-labelledby="contact-tab">
					<div class="row">
						<div class="col-lg-12">
							<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="container">
						<div class="hot-product-img">
							<div class="row">
								<c:forEach items="${lstmn}" var="l" begin="0" end="7">
									<div class="col-lg-3 col-md-4 col-sm-6 col-12">
										<div class="hot-product-img-one sanphamoi">
											<div class="thump">
												<span>Mã <b>${l.id}</b></span>
												<div class="image-zoom">
													...
													<c:forEach items="${l.listHinhAnh}" var="p" begin="2"
														end="2">
														<img class="zooom-product"
															src="${rootpath}public/img/${p.name}" alt="">
													</c:forEach>
												...
												<form action="${roopath}product/ao-nu/${l.id}" method="get">
													<button>View Product Detail</button>
												</form>
											</div>
											<div class="content">
			...
			<div class="product-two">
				<div class="row">
					<div class="owl-carousel owl-theme" id="manhca">
						<c:forEach items="${lstmn}" var="sp" begin="0" end="8">
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="hot-product-img-one item">
									<div class="thump">
										<span> Mã: <b>${sp.id}</b></span>
										<div class="image-zoom">
											<c:forEach items="${sp.listHinhAnh}" var="p" begin="1"
												end="1">
												<img src="${rootpath}public/img/${p.name}" alt="">
											</c:forEach>
											<c:forEach items="${sp.listHinhAnh}" var="p" begin="2"
												end="2">
												<img class="zooom-product"
													src="${rootpath}public/img/${p.name}" alt="">
											</c:forEach>
