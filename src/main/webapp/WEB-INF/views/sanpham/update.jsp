					...
					<div class="form-holder">
						<div class="form-content">
							<div class="form-items" style="border: none;">
								...
								<sform:form id="sanphamsubmit" style="padding: 0px 133px" modelAttribute="spct"
									...
									<c:forEach items="${spct.listHinhAnh}" var="p" begin="0" end="0">
										<img style="width: 100%; height: 300px; border-radius: 6px;" src="${rootpath}public/img/${p.name}"/>
									</c:forEach>
			 						</div>
			 						<div class="col-md-12" style="padding-top: 16px">
		                               <input type="file" name="uploadFile" id="image" multiple="multiple" min="4">
									</div>
									<div class="col-md-12" style="padding-top: 16px">
									...
									<div class="form-button mt-3">
										<button onclick="submitDetailsForm()"  type="submit" class="btn btn-primary suathemsp"
